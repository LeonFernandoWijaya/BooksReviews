...
<?php endif; ?>
    ...
    <div class="mb-4">
        <a href="<?php echo e(route('books.reviews.create', $book)); ?>" class="reset-link">Add a review!</a>
    </div>
                ...
                <li class="book-item mb-4">
                    <div>
                        <div class="mb-2 flex items-center justify-between">
                            <div class="font-semibold"><?php if (isset($component)) { $__componentOriginal39f2763c88a2b6449e1e2b6e6a25d4ae = $component; } ?>
<?php $component = App\View\Components\StarRating::resolve(['rating' => $review->rating] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('star-rating'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\StarRating::class))->getConstructor()): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leonw\Desktop\book-review\resources\views/books/show.blade.php ENDPATH**/ ?>